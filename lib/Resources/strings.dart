class StringResources {
  ...
  //Categories
  final String cFiltertop = "탑";
  final String cFilterone = "원피스";
  final String cFilterpolo = "폴로";
  final String cFilterskirt = "스커트";
  final String cFilterknit = "니트웨어";
  final String cFiltershorts = "쇼츠";
  final String cFilterjacket = "코트 & 자켓";
  final String cFilterpants = "팬츠";
  final String cFiltervest = "베스트 & 질레";
  final String cFilterdenim = "데님";
  final String cFiltershirt = "블라우스 & 셔츠";
  final String cFilterTitle = "카테코리별 검색";
  final String cFilterClothes = "의류";
  final String cFilterBag = "가방";
  ...
  final String hSchedule3 = "아래 정보가 맞는지 최종 확대인해주세요.";
